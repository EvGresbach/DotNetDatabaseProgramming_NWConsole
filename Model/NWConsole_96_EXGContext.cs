...
{
    public partial class NWConsole_96_EXGContext : DbContext
    {
        public NWConsole_96_EXGContext()
        {
        }

        public NWConsole_96_EXGContext(DbContextOptions<NWConsole_96_EXGContext> options)
            : base(options)
        {
        }
